...
namespace OpenTelemetry.Trace
{
    ...
    public abstract class TracerProviderBuilder
    {
        ...
        /// <summary>
        /// Adds given activity operation names to the list of subscribed sources.
        /// </summary>
        /// <remarks>
        /// This is provided to capture legacy <see cref="Activity"/> objects created without using the <see cref="ActivitySource"/> API.
        /// </remarks>
        /// <param name="operationNames">Operation name of the <see cref="Activity"/> objects to capture.</param>
        /// <returns>Returns <see cref="TracerProviderBuilder"/> for chaining.</returns>
        public abstract TracerProviderBuilder AddLegacySource(params string[] operationNames);
    }
}
